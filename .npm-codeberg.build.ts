...
await transform({
	...
	metadata: {
		...
		homepage: "https://codeberg.org/hugoalh/pressure-es#readme",
		bugs: {
			url: "https://codeberg.org/hugoalh/pressure-es/issues"
		},
		license: "MIT",
		author: "hugoalh",
		repository: {
			type: "git",
			url: "git+https://codeberg.org/hugoalh/pressure-es.git"
		},
		private: false,
		publishConfig: {
			access: "public"
